...
public class BbsController {
    ...
    @GetMapping("/bbs")
    public Page<BbsMainDto> bbsMainList(Pageable pageable,
                                        BbsSearchCondition searchCondition,
                                        @RequestParam(value = "bbsCategoryCd", required = false) String bbsCategoryCd) {
