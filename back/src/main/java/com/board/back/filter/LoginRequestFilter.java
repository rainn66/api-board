...
//
//    private static final String[] notFilteringList = {"/side", "/board", "/login", "/user/signup", "/css/*", "/*.ico"};
//
...
//                log.info("PatternMatchUtils is true");
//                doFilter(request, response, filterChain);
//            } else {
//                log.info("PatternMatchUtils is false");
